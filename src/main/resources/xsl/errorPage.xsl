        ...
        <xsl:choose>
          ...
          <xsl:when test="/mcr_error/@HttpError = '404'">
            ...
            <p>
              ...
              Bitte versuchen Sie mithilfe der <a href="/index.html">Suche</a> die gewünschte Seite
              zu finden oder schreiben Sie eine Mail an <span class="madress">open-access.bib [at] hawk.de</span> und
          ...
          <xsl:when test="/mcr_error/@HttpError = '403'">
            ...
            <p>
              ...
              schreiben Sie eine Mail an <span class="madress">open-access.bib [at] hawk.de</span>.
              <br />
              <br />
              Vielen Dank!
            </p>
